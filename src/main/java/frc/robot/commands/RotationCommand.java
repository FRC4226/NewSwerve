...
public class RotationCommand extends CommandBase
{
  ...
  public RotationCommand(SwerveSubsystem swerveSubsystem)
  {
  ...
  public void execute()
  {
    ...
    swerveSubsystem.drive(new Translation2d(0.0, 0.0), 90, true, false);
  }
  ...
  {
   // swerveSubsystem.drive(new Translation2d(0.0, 0.0), 180, true, false);
  }
}
