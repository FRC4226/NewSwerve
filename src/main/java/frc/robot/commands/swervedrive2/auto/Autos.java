...
public final class Autos
{
   ...
   */
  public static CommandBase MidBalence(SwerveSubsystem swerve)
  {
    boolean               onTheFly = true; // Use the path defined in code or loaded from PathPlanner.
    PathPlannerTrajectory Balence;
    if (onTheFly)
    {
      // Simple path with holonomic rotation. Stationary start/end. Max velocity of 4 m/s and max accel of 3 m/s^2
      Balence = PathPlanner.generatePath(
          new PathConstraints(1, 1),//4, 3
          new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
// position, heading(direction of travel), holonomic rotation
// position, heading(direction of travel), holonomic rotation
          new PathPoint(new Translation2d(-2, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),

          new PathPoint(new Translation2d(-3.5, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),

          new PathPoint(new Translation2d(-2, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)) //-1.85
          // position, heading(direction of travel), holonomic rotation
                                        );
    } else
    {
...
//    swerve.postTrajectory(example);
    return Commands.sequence(new FollowTrajectory(swerve, Balence, true));
  }



  public static CommandBase Backwards(SwerveSubsystem swerve)
  {
    boolean               onTheFly = true; // Use the path defined in code or loaded from PathPlanner.
    PathPlannerTrajectory backwards;
    if (onTheFly)
    {
      // Simple path with holonomic rotation. Stationary start/end. Max velocity of 4 m/s and max accel of 3 m/s^2
      backwards = PathPlanner.generatePath(
          new PathConstraints(1, 1),//4, 3
          new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
// position, heading(direction of travel), holonomic rotation
// position, heading(direction of travel), holonomic rotation
          ...
          new PathPoint(new Translation2d(-3.75, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0))
                                        );
    } else
    {
      List<PathPlannerTrajectory> example1 = PathPlanner.loadPathGroup("SamplePath", new PathConstraints(4, 3));
...
//    swerve.postTrajectory(example);
    return Commands.sequence(new FollowTrajectory(swerve, backwards, true));
  }
  ...
  public static CommandBase TwoAutoleft(SwerveSubsystem swerve)
  {
    boolean               onTheFly = true; // Use the path defined in code or loaded from PathPlanner.
    PathPlannerTrajectory Twoleft;
    if (onTheFly)
    {
      // Simple path with holonomic rotation. Stationary start/end. Max velocity of 4 m/s and max accel of 3 m/s^2
      Twoleft = PathPlanner.generatePath(
...
//    swerve.postTrajectory(example);
    return Commands.sequence(new FollowTrajectory(swerve, Twoleft, true));
  }
  ...
  public static CommandBase TwoAutoRight(SwerveSubsystem swerve)
  {
    boolean               onTheFly = true; // Use the path defined in code or loaded from PathPlanner.
    PathPlannerTrajectory Tworight;
    if (onTheFly)
    {
      // Simple path with holonomic rotation. Stationary start/end. Max velocity of 4 m/s and max accel of 3 m/s^2
      Tworight = PathPlanner.generatePath(
          new PathConstraints(1.5, 1),//4, 3
          new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
// position, heading(direction of travel), holonomic rotation
          new PathPoint(new Translation2d(-1, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
...
//    swerve.postTrajectory(example);
    return Commands.sequence(new FollowTrajectory(swerve, Tworight, true));
  }
