...
public class TwicePieceDriveRight extends ParallelCommandGroup {
  public TwicePieceDriveRight(SwerveSubsystem drivebase, Arm m_Arm, Gripper m_Gripper) {
    addCommands(
      Autos.TwoAutoRight(drivebase),
